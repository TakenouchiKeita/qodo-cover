...
class AICaller:
    ...
    def call_model(self, prompt: dict, stream=True):
        ...
        if prompt["system"] == "":
            ...
            if self.model in ["o1-preview", "o1-mini", "azure/o1-preview", "azure/o1-mini", "azure/o1", "azure/o3-mini"]:
        ...
        if self.model in ["o1-preview", "o1-mini", "o1", "o3-mini", "azure/o1-preview", "azure/o1-mini", "azure/o1", "azure/o3-mini"]:
